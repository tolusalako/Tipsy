...
/**
 * Helper class for showing and canceling tip notifications.
 * <p>
...
public class TipNotification {
	 ...
	 * presentation of tip notifications. Make sure to follow the <a
	...
	public static void notify(final Context context,
		...
		final String title = res.getString(
				R.string.tip_notification_title_template, exampleString);
		final String text = res.getString(
				R.string.tip_notification_placeholder_text_template,
				exampleString);
